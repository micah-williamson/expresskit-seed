...
export class WidgetService {
     ...
     */
    public static updateWidget(update: Widget): Promise<void> {
         return new Promise((resolve, reject) => {
     ...
     */
    public static deleteWidget(widgetId: Widget): Promise<void> {
         return new Promise((resolve, reject) => {
    ...
    /**
     * Resolves TRUE if the given authToken is the owner of the given widgetId
     */
    public static isOwner(@Auth() authToken: AuthToken, @Param('id') widgetId: number): Promise<any> {
        ...
        setTimeout(() => {
             ...
             * reject('This it not your widget.');
             * 
             * [OR]
             * 
